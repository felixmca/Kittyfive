...
Kling 3.0 · image + prompt → video · 9:16 · 5 s · 1080p (or 720p) · sound off ·
"enhance prompt" off. Crop the photo to 9:16 first, Kitty in the top two-thirds.
...
- `clip/`: the video artta gives you (any file name; the newest is used)
- `extras/`: 2–4 real photos from the same time (optional)

Full handover: `docs/HANDOVER-01-STORY-ASSETS.md`.
